...
# --- t=0 の SOM貪欲法用 ε-greedy パラメータ ---
USE_EPSILON_SOM = True  # t=0 で ε-greedy を使うか
EPSILON_SOM = 0.3       # 30%の確率でランダム探索する
            ...
            for _ in range(NUM_ANTS):
                ...
                if t == 0:
                    ...
                    for _ in range(TIMES_TO_SEARCH_HOP):
                        ...
                        # 3. ε-greedy による最終決定
                        next_node = None
                        if USE_EPSILON_SOM and random.random() < EPSILON_SOM:
